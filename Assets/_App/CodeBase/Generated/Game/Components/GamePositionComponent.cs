...
public partial class GameEntity {
    ...
    public GameplayLayer.Game.PositionComponent position { get { return (GameplayLayer.Game.PositionComponent)GetComponent(GameComponentsLookup.Position); } }
    ...
    public void AddPosition(float newX, float newY, float newZ) {
        ...
        var component = (GameplayLayer.Game.PositionComponent)CreateComponent(index, typeof(GameplayLayer.Game.PositionComponent));
        component.X = newX;
        component.Y = newY;
        component.Z = newZ;
