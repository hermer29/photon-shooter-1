...
public partial class GameEntity {
    ...
    public GameplayLayer.Game.RotationComponent rotation { get { return (GameplayLayer.Game.RotationComponent)GetComponent(GameComponentsLookup.Rotation); } }
    public bool hasRotation { get { return HasComponent(GameComponentsLookup.Rotation); } }

    public void AddRotation(float newY, float newX) {
        var index = GameComponentsLookup.Rotation;
        var component = (GameplayLayer.Game.RotationComponent)CreateComponent(index, typeof(GameplayLayer.Game.RotationComponent));
        component.Y = newY;
        component.X = newX;
        AddComponent(index, component);
    }

    public void ReplaceRotation(float newY, float newX) {
        var index = GameComponentsLookup.Rotation;
        var component = (GameplayLayer.Game.RotationComponent)CreateComponent(index, typeof(GameplayLayer.Game.RotationComponent));
        component.Y = newY;
        component.X = newX;
